...
public class Strings {
    ...
    public final static ObservableList<String> choiceBox = FXCollections.observableArrayList("Rury i kable", "Elementy",
            "Zawory i silniki");
    public final static ObservableList<String> addItemBox = FXCollections.observableArrayList("Rury", "Kable",
    ...
    public final static String[] addItemNames = { "Dodaj rure", "Dodaj kabel", "Dodaj srube/zakretke/podkladke",
