...
public class Strings {
	...
	public final static ObservableList<String> addItemBox = FXCollections.observableArrayList("Rury", "Kable", "Sruby", "Nakretki", "Podkladki", "Zawory", "Silniki");
	...
	public final static String [] addItemLayouts = { "/pl/pwr/workshop/data/view/AddPipeLayout.fxml",
									  ...
									  "/pl/pwr/workshop/data/view/AddScrewLayout.fxml",
									  "/pl/pwr/workshop/data/view/AddNutLayout.fxml",
									  "/pl/pwr/workshop/data/view/AddWasherLayout.fxml",
